       ...
       <section class="mx-auto container bg-white border border-gray-400 min-h-screen p-12">
        <div class="flex justify-between">
            <div class="flex flex-col space-y-5 w-1/2s">
                ...
                <textarea v-model="data.sender" id="" cols="30" rows="2"></textarea>
                <div class="flex space-x-2">
                    <div class="flex flex-col">
                        <span>Bill to</span>
                        <textarea v-model="data.billTo" id="" cols="30" rows="2"></textarea>
                    </div>
                    <div class="flex flex-col">
                        <span>Ship to</span>
            ...
            <div class="flex flex-col w-1/2 items-end">
                ...
                <input class="w-[200px] text-right" type="text" v-model="data.invoiceNumber" placeholder="Invoice Number">
