...
<template>
   <section class="mx-auto container bg-white border border-gray-400 min-h-screen p-12">
    ...
    <div class="mt-20">
      <table class="table-auto w-full">
        ...
        <tr >
          ...
          <td class="py-1 pr-5 text-right text-gray-800"></td>
        </tr>
      </table>
      <button  class="mt-5 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-2 rounded">
        Add More
      </button>
    ...
    <div class="mt-[200px]">
      ...
      <button  class="m-5 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-2 rounded">
        Add Invoice
      </button>
          </div>
        </div>
